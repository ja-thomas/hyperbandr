...
myBraninBenchmark = benchmarkThis(10)
```

Unsurprisingly, with hyperband standard configurations, bracket 5 does very bad on the branin problem (max.ressources = 81 and prop.discard = 3).
